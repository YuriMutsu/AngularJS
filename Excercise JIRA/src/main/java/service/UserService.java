...
import static util.MyUtil.getConnectionRespondBody;
import static util.MyUtil.getCookies;
...
public class UserService{
    public static JSONObject getUserInformation(Session session) throws Exception {
        ...
        Connection req = Jsoup
                ...
                .cookies(getCookies(session)).timeout(Constant.CONNECTION_TIMEOUT).ignoreContentType(true)
