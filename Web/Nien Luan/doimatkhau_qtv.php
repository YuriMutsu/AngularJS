...
<head>
    <meta charset="utf-8">
    <title>Trang quản trị/Đổi mật khẩu</title>
    <meta charset="utf-8">
...
//doi mat khau la cập nhập lại số tai khoan trong csdl
    ...
    if(isset($_POST['doimatkhau'])){
        ...
        //láy dữ liệu từ form
        $matk         =   $_POST["matkhaucu"];
        $matkhaumoi         =   $_POST["matkhaumoi"];
        $nhaplaimatkhau     =   $_POST["nhaplaimatkhau"];
        
        //lay sotaikhoan ra để so sánh
        $sql = "select MATK from nguoidung where MATK = '$matk' ";
			$query = mysqli_query($conn,$sql);
			$num_rows = mysqli_num_rows($query); 
        
        //kiểm tra dư liệu nhập có đầy đủ
        if($matk == "" || $matkhaumoi == "" || $nhaplaimatkhau == ""){
            ...
            $sql = "UPDATE nguoidung SET MATK = '$matkhaumoi' where MATK = '$matk' ";
    ...
    <div class="container">
     <div class="row panel panel-info">    
       ...
       <div class="row">
		...
		<div class ="panel-heading">
		 <center><h4>ĐỔI MẬT KHẨU QUẢN TRỊ VIÊN</h4></center>
		</div>
		
		<div class="panel-body">
		<form class="form-horizontal col-sm-offset-1 col-sm-8" action="doimatkhau_qtv.php" method="post">
            <br>
		 ...
		 <div class="form-group">
                            <label class="control-label col-sm-5" for="matkhaumoi">Nhập mật khẩu mới:</label>
                                <div class="col-sm-7 ">
