    ...
    if(isset($_POST['dangnhap'])){
        ...
        //neu tim thay makh thi luu vao bang dang ky
            ...
            while($row = $query->fetch_assoc()) {
                ...
                $_SESSION['QUYENSD'] = $quyensd;
                echo '<script>alert("Bạn đã đăng nhập với quyền QUẢN TRỊ!!!!"); </script>';
...
?>
    ...
    <div class="container">
     <div class="row panel panel-info">            
		...
		<div class ="panel-heading">
		<center><h4>ĐĂNG NHẬP TÀI KHOẢN QUẢN TRỊ</h4></center>
		</div>
		
		<div class="panel-body">
		<form class="sign-in col-sm-8 col-sm-offset-2" action="dangnhap_qtv.php" method="post">

			<div class="form-group ">
				<label class="control-label col-sm-3 " for="tendn" > Tên Đăng Nhập:</label>
				 <div class="col-sm-7">
                                <input type="text" class="form-control" name="tendn" placeholder="Nhâp vào tên đănh nhập">
                            </div>
			</div>	<br><br>			
		 <div class="form-group">
                            <label class="control-label col-sm-3" for="password">Mât khâu:</label>
                                <div class="col-sm-7 ">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3  col-sm-8">
                                 <input class="btn btn-primary col-sm-offset-1" name="dangnhap" type="submit" value="Đăng Nhập" >
                                </input>
                            </div>
                        </div>
		</form>
