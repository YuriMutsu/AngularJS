    ...
    <div class="container" style = "background-color:'red   '" >
     ...
     <div class="row panel panel-info">           
                ...
                <div class="col-sm-4 ">
                    <br><br><br>
                       <form class="searchform cf" action="timkiem.php" method="get">
                        ...
                        <button type="submit" name="ok" value="search">Tim</button>
                    </form>
                </div>                  
                <div class="col-sm-8">
       ...
       <div class="row panel panel-info">           
        <div class="col-sm-12"> 
            <div class="row" >
                    <form class = "panel panel-info" action="laysanpham.php" method="post">
                            <div class="panel-heading">Danh Mục Các Sản Phẩm Khuyến Mãi </div>
...
$d = 0;
$sql = "SELECT * FROM sanpham WHERE KHUYENMAI > 0 AND TINHTRANG IS NULL";
