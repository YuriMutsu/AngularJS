...
<body>
                        ...
                        <div class="input-group has-success">
                            <ul >
                                ...
                                <?php elseif ($_SESSION['QUYENSD'] == "Administrator"): ?>
                                    <li><center><img src="icon/user_profile.png" height="30" ></center> </li>
                                    <li><a href="captaikhoan_nv.php">CẤP TKNV</a></li>
                                <?php elseif ($_SESSION['QUYENSD'] == "Nhan Vien"): ?>
                                    <li><center><img src="icon/bills.png" height="30" ></center> </li>
                   ...
                   <form class="form-inline" role="form">
                        <div class="input-group has-success">
                            <ul >
                                ...
                                <?php elseif ($_SESSION['QUYENSD'] == "Administrator"): ?>
                                    <li><center><img src="icon/edit_user-512.png" height="30" ></center> </li>
                                    <li><a href="captaikhoan.php">CẤP TKKH</a></li>
                                <?php elseif ($_SESSION['QUYENSD'] == "Nhan Vien"): ?>
                                    <li><center><img src="icon/Korawan_M_business2_10-512.png" height="30" ></center> </li>
                                    <li><a href="xuathoadon.php">IN HÓA ĐƠN</a></li>
                                <?php else:   ?>
                                    <li><center><img src="icon/writing.jpg" height="30" ></center> </li>
                                    <li><a href="dangsanpham.php">ĐĂNG BÀI</a></li>
                                <?php endif ?>
                  ...
                  <form class="form-inline" role="form">
                    <div class="input-group has-success">
                        <ul>
                                ...
                                <?php elseif ($_SESSION['QUYENSD'] == "Administrator"): ?>
                                    <li><center><img src="icon/icon_55-512.png" height="30" ></center> </li>
                                    <li><a href="capnhap_sanpham.php">SẢN PHẨM</a></li>
                                <?php else:   ?>
                                        <li><center><img src="icon/icon_55-512.png" height="30" ></center> </li>
                                        <li><a href="sanpham.php">SẢN PHẨM</a></li>
                                <?php endif ?>
                ...
                <div >
                   <form class="form-inline" role="form">
                        <div class="input-group has-success">
                            <ul>               
                                <?php if (!isset($_SESSION['tenkh'])): ?>
                                        <li><center><img src="icon/changepass.png" height="30" ></center> </li>
                                        <li><a href="doimatkhau.php">ĐỔI MẬT KHẨU</a></li>
                                <?php elseif ($_SESSION['QUYENSD'] == "Administrator"): ?>
                                    <li><center><img src="icon/changepass.png" height="30" ></center> </li>
                                    <li><a href="doimatkhau_qtv.php">ĐỔI MẬT KHẨU</a></li>
                                 <?php elseif ($_SESSION['QUYENSD'] == "Nhan Vien"): ?>
                                    <li><center><img src="icon/changepass.png" height="30" ></center> </li>
                                    <li><a href="doimatkhau_nv.php">ĐỔI MẬT KHẨU</a></li>
                                <?php else:   ?>
                                        <li><center><img src="icon/changepass.png" height="30" ></center> </li>
                                        <li><a href="doimatkhau.php">ĐỔI MẬT KHẨU</a></li>
                                <?php endif ?>
  ...
  <!--MODAL XÓA TẤT CẢ-->
<form action="capnhap.php" method="post">                
...
if(isset($_POST['allspkh'])){
    //xóa tất cả các đơn đặt hàng trừ hóa đơn
            $sql = "DELETE FROM dangsanpham,sanpham WHERE MASP.dangsanpham = MASP.sanpham";
    if($conn->multi_query($sql) == TRUE){
