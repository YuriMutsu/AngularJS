...
<head>
    <meta charset="utf-8">
    <title>Trang nhân viên/Đổi mật khẩu</title>
    <meta charset="utf-8">
...
?>
    ...
    <div class="row">
        <div class="panel panel-info">
		          <div class ="panel-heading">
		                  <center><h4>ĐỔI MẬT KHẨU NHÂN VIÊN</h4></center>
		  </div>
		  <div class="panel-body">
		          <form class="form-horizontal col-sm-8 col-sm-offset-1" action="doimatkhau_nv.php" method="post">
                        <br>
